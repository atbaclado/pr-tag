    ...
    function genPDF(){
      html2canvas(document.getElementById("shet"),{
        ...
        var img = canvas.toDataURL("image/png");
          var doc = new jsPDF('p', 'mm', [320, 210]);
          doc.addImage(img,'PNG', 10,10);
          doc.save('Disbursement Voucher.pdf');
        }
      });      
    }
      ...
      <aside id="activerSide" class="col-md-4 sidebar sidebar-left">
        <div class="row widget">
          <div class="col-xs-12" style="border-bottom:2px solid black;">
                        <h4 class="labelbutton" id="activer"><a href="PR_Form3_Download.php">Disbursement Voucher</a></a></h4>
            <p align="center">  
                        </p>
          </div>
        </div>
        <div class="row widget">
          <div class="col-xs-12">
           <p align="center"> <a class="subbutton" href = "javascript: genPDF()">Download as pdf</a></p>        
          </div>
        </div>
