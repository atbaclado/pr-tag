...
<head>
  ...
  $(document).ready(function(){
    ...
    '<label><input type="number" name="qty[]" placeholder="Quantity" min="1" style="width:65px; margin-left:0px;" required/></label>'+
    ...
    '<label><input type="number" name="ucost[]" min="1" style="width:102px; margin-left:2px;" required="required" placeholder="Unit Cost"></input></label>'+
  ...
  <aside id="activerSide" class="col-md-4 sidebar sidebar-left">
    ...
    <h4 class="labelbutton" id="activer"><a href="PR_Form1_Display.php">Purchase Request</a></h4>
    <p align="center">
    <input class="subbutton" type="submit" name="newpr" width="100" value="CREATE"/>
    </p>
    </div>
    </div>
