...
<head>
	...
	<title>iBugs - Need Attention PRs</title>
	...
	<div class="container">
		...
		<div class="row">
		 	...
		 	<aside id="activerSide" class="col-md-4 sidebar sidebar-left" style="height:450px;">
				...
				<div class="row widget">
					<div id="activerRow" class="col-xs-12">
						<h4 class="btn" id="activer">Needs Attention!</h4>
			...
			<article class="col-md-8 maincontent">
				...
				<h4>Needs Attention Purchase Request </h4>  
				<div class=" col-md-9 col-lg-9 "> 
					...
					<tbody>
						<form action="php/track_setpr.php" method="get">
							<?php
								$query = "SELECT * FROM tracking , purchase WHERE (track_flow = " . $_SESSION['user_ofc'] . " OR track_office = " . $_SESSION['user_ofc'] . ") AND track_status = 'On Hold' AND pr_id = track_prid";
								$result = pg_query($dbconn,$query);
								if(!$result) {
									$errormessage = pg_last_error();
									$_SESSION['errormsg'] = 'PR on hold. ' . $errormessage;
