        ...
        <div class="row widget">
          <div id="activerRow" class="col-xs-12" style="border-bottom:2px solid black;">
            ...
            <p align="center">
                        ...
                        <input class="subbutton" type="submit" name="updatedv" width="100" value="UPDATE"/> &nbsp;
                        <input class="subbutton" type="submit" name="canceldv" width="100" value="CANCEL"/>
                        </p>
          </div>
        </div>
        <!-- <div class="row widget">
